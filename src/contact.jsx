...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        ...
        "template_0s8e2l4",       // Updated to your actual EmailJS template ID
        form.current,
  ...
  const handleDownloadCV = () => {
    ...
    link.href = 'https://drive.google.com/file/d/1zX13-hNRxo2wezwZ1AmVspZoSj9DqkX5/view';
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 hover:border-yellow-400/40 transition-all duration-300 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-yellow-300 font-medium text-sm mb-1">Btech Computer Science and Engineering</p>
