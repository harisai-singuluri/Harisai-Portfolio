...
const CommandPalette = () => {
  ...
  const commands = [
    ...
    },
    {
      ...
      category: 'Actions',
      action: () => {
        navigator.clipboard.writeText('singuluriharisai143@gmail.com');
        setOpen(false);
    ...
    },
    {
      ...
      category: 'Links',
      action: () => {
        window.open('https://github.com/harisai-singuluri', '_blank');
        setOpen(false);
      },
      shortcut: 'O G'
    },
    {
      ...
      category: 'Links',
      action: () => {
        window.open('https://www.linkedin.com/in/singuluri-harisai/', '_blank');
        setOpen(false);
      },
      shortcut: 'O L'
    },
