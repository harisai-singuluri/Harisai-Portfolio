...
import profileImage from '../../assets/harisai.png';
import { FaInstagram, FaLinkedin, FaXTwitter, FaGithub, FaYoutube } from 'react-icons/fa6';
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center">
        ...
        <div className="space-y-6 sm:space-y-8 text-center lg:text-left flex flex-col justify-center lg:pr-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Hi, I'm <span className="inline-block">Harisai Singuluri</span>
          </h1>
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0">
            Software developer passionate about building reliable, scalable, and high-performance applications. Focused on clean code and efficient system design, with strong Java proficiency and an active interest in learning, upskilling, and integrating AI into software solutions.
          </p>
