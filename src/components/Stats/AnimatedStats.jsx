      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/40 transition-all duration-300">
            ...
            <p className="text-gray-400">Continuously upskilling in AI, exploring practical applications, learning modern testing technologies, and strengthening DSA for scalable solutions.</p>
          </div>

          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-400/40 transition-all duration-300">
            <div className="text-3xl mb-4">🤝</div>
            <h3 className="text-xl font-bold text-white mb-3">Community Contributor</h3>
            <p className="text-gray-400">Active on GitHub, LeetCode, Linkdin, and other platforms solving problems</p>
          </div>
        </div>
      </div>
