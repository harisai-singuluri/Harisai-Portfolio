...
import HarisaiPhoto from '../../assets/harisai.png';
...
const Contact = () => {
  ...
  useEffect(() => {
    emailjs.init("ig91-wY6Zd2ATef5h"); // Updated public key
  }, []);
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_eqhnsfj",        // Your new SMTP EmailJS service ID
        "template_0s8e2l4",       // Your actual EmailJS template ID
        form.current,
        "ig91-wY6Zd2ATef5h"        // Updated EmailJS public key
      )
      .then(
        (result) => {
          setIsLoading(false);
  ...
  const handleDownloadCV = () => {
    ...
    link.href = 'https://drive.google.com/file/d/1RxxytGlnbsRLKwMAO27LlbRlJzwMpU0b/view';
    link.download = 'Singuluri_Harisai_CV.pdf';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50 hover:border-indigo-400/40 transition-all duration-300 hover:shadow-lg">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-white mb-1">Singuluri Harisai</h3>
                  <p className="text-indigo-300 font-medium text-sm mb-1"> Btech Computer Science and Engineering </p>
                  <p className="text-gray-400 text-xs">
                  Software Developer | AI Enthusiast | Developer at the Intersection of Code, AI, and Digital Defense
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 backdrop-blur-sm rounded-xl p-5 border border-indigo-400/30 hover:border-indigo-400/50 transition-all duration-300">
              ...
              <a href="mailto:singuluriharisai143@gmail.com">

                <span>📧</span>
                <span>Send Email</span>
              </a>
              <p className="text-xs text-gray-400 mt-2 text-center">
                <span className="italic">Note: This will open your default email app. If nothing happens, please use the contact form or email me directly at <a href="mailto:vivekkumarlpu1@gmail.com" className="underline text-yellow-300">singuluriharisai143@gmail.com</a>.</span>
              </p>
            </div>
