      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-2">
            ...
            <span className="text-white">Singuluri</span>
            <span className="text-indigo-400">/</span>
            <span className="text-white">Harisai</span>
            <span className="text-cyan-400">/&gt;</span>
          </h2>
          <p className="text-gray-300 text-sm mb-4">Software Developer & AI Enthusiast</p>

          {/* Social Media Icons */}
          <div className="flex flex-col items-center space-y-3 mb-4">
            <div className="flex justify-center space-x-4">
            {[
              { icon: <FaGithub size={20} />, link: "https://github.com/harisai-singuluri", label: "GitHub" },
              { icon: <FaLinkedin size={20} />, link: "https://www.linkedin.com/in/singuluri-harisai/", label: "LinkedIn" },
              { icon: <FaInstagram size={20} />, link: "https://www.instagram.com/harisai_aura?igsh=dzJhbjJ6dHZkbmlw&utm_source=qr", label: "Instagram" },
              { icon: <FaYoutube size={20} />, link: "https://youtube.com/@harisai_universe?si=aP_hQH0cR5mOmSur", label: "YouTube" },
            ].map((item, index) => (
              <a
                key={index}
                href={item.link}
            ...
            <div>
              ...
              <a
                href="https://drive.google.com/file/d/1RxxytGlnbsRLKwMAO27LlbRlJzwMpU0b/view"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="space-y-1">
            <p className="text-gray-400 text-xs">
              © 2025 Singuluri Harisai. All rights reserved.
            </p>
